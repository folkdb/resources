...
import allCategories from './api/all-categories.js'
import createCategory from './api/create-category.js'
...
const testQuery = async (q) => {
  const response = await q();
  
  console.log(JSON.stringify(response, undefined, 2));
}

testQuery(createCategory);
console.log('---');
testQuery(allCategories);
